...
INSERT INTO CourseSubTopic (course_code, topic_id, sub_topic_id, sub_topic, is_being_tracked, lec_reg_no) VALUES
    ("CS 2001", 01, 01.1, "Hierarchical Model", 1, "2014/LC/0034"),
    ("CS 2001", 01, 01.2, "Network Model", 1, "2014/LC/0034"),
    ("CS 2001", 01, 01.3, "Relational Model", 1, "2014/LC/0034"),
    ("CS 2001", 01, 01.4, "Object Relational Model", 1, "2014/LC/0034"),
    ("CS 2001", 02, 02.1, "Normalization", 1, "2014/LC/0034"),
    ("CS 2001", 02, 02.2, "Cardinality and Participation", 1, "2014/LC/0034"),
    ("CS 2001", 02, 02.3, "ER & EER Diagrams", 1, "2014/LC/0034"),
    ("CS 2001", 03, 03.1, "Query Languages", 1, "2014/LC/0034"),
    ("CS 2001", 03, 03.2, "MySQL CRUD Operations", 1, "2014/LC/0034"),
    ("CS 2001", 03, 03.3, "MySQL Joins", 1, "2014/LC/0034"),
    ("CS 2002", 01, 01.1, "Prepositional Logic", 1, "2006/LC/0014"),
    ("CS 2002", 01, 01.2, "Predicate Logic", 1, "2006/LC/0014"),
    ("CS 2002", 01, 01.3, "Arguments", 1, "2006/LC/0014"),
    ("CS 2002", 02, 02.1, "Set Notation", 1, "2006/LC/0014"),
    ("CS 2002", 02, 02.2, "Set Thoeries", 1, "2006/LC/0014"),
    ("CS 2002", 02, 02.3, "Solving Problems using Sets", 1, "2006/LC/0014"),
    ("CS 2002", 03, 03.1, "Functions", 1, "2006/LC/0014"),
    ("CS 2002", 03, 03.2, "Binary Relations", 1, "2006/LC/0014"),
    ("CS 2002", 03, 03.3, "Equivalance Relations", 1, "2006/LC/0014"),
    ("CS 2002", 03, 03.4, "Partial Order Relations", 1, "2006/LC/0014"),
    ("CS 2003", 01, 01.1, "Introduction to Stacks", 1, "2018/LC/0022"),
    ("CS 2003", 01, 01.2, "Implementing a Stack", 1, "2018/LC/0022"),
    ("CS 2003", 01, 01.3, "Adding & Deleting Data", 1, "2018/LC/0022"),
    ("CS 2003", 02, 02.1, "Introduction to Queues", 1, "2018/LC/0022"),
    ("CS 2003", 02, 02.2, "Implementing a Queue", 1, "2018/LC/0022"),
    ("CS 2003", 02, 02.3, "Adding & Deleting Data", 1, "2018/LC/0022"),
    ("CS 2003", 03, 03.1, "Introduction to Linked Lists", 1, "2003/LC/0004"),
    ("CS 2003", 03, 03.2, "Implementing a Linked List", 1, "2003/LC/0004"),
    ("CS 2003", 03, 03.3, "Adding & Deleting Nodes", 1, "2003/LC/0004"),
    ("CS 2004", 01, 01.1, "Algorithms", 1, "2003/LC/0004"),
    ("CS 2004", 01, 01.2, "Analysing Algorithms", 1, "2003/LC/0004"),
    ("CS 2004", 02, 02.1, "Big O Notation", 1, "2003/LC/0004"),
    ("CS 2004", 02, 02.2, "Big Omega Notation", 1, "2003/LC/0004"),
    ("CS 2004", 02, 02.3, "Big Theta Notation", 1, "2003/LC/0004"),
    ("CS 2004", 03, 03.1, "Bubble Sort", 1, "2003/LC/0004"),
    ("CS 2004", 03, 03.2, "Insertion Sort", 1, "2003/LC/0004"),
    ("CS 2004", 03, 03.3, "Selection Sort", 1, "2003/LC/0004"),
    ("IS 2001", 01, 01.1, "History of C Language", 1, "2018/LC/0022"),
    ("IS 2001", 01, 01.2, "Basic Syntax", 1, "2018/LC/0022"),
    ("IS 2001", 01, 01.3, "C Libraries", 1, "2018/LC/0022"),
    ("IS 2001", 02, 02.1, "Sequence", 1, "1999/LC/0008"),
    ("IS 2001", 02, 02.2, "Selection", 1, "1999/LC/0008"),
    ("IS 2001", 02, 02.3, "Iteration", 1, "1999/LC/0008"),
    ("IS 2001", 03, 03.1, "Stacks using C", 1, "1999/LC/0008"),
    ("IS 2001", 03, 03.2, "Queues using C", 1, "1999/LC/0008"),
    ("IS 2001", 03, 03.3, "Linked Lists using C", 1, "1999/LC/0008"),
    ("IS 2002", 01, 01.1, "History of RAD", 1, "2014/LC/0034"),
    ("IS 2002", 01, 01.2, "Principles of RAD", 1, "2014/LC/0034"),
    ("IS 2002", 01, 01.3, "JavaScript", 1, "2016/LC/0015"),
    ("IS 2002", 02, 02.1, "Mongo DB", 1, "2016/LC/0015"),
    ("IS 2002", 02, 02.2, "Express JS", 1, "2016/LC/0015"),
    ("IS 2002", 02, 02.3, "React JS", 1, "2016/LC/0015"),
    ("IS 2002", 02, 02.4, "Node JS", 1, "2016/LC/0015"),
    ("IS 2002", 03, 03.1, "Agile Principles", 1, "2014/LC/0034"),
    ("IS 2002", 03, 03.2, "Agile Practices", 1, "2014/LC/0034"),
    ("IS 2002", 03, 03.3, "Agile Testing", 1, "2014/LC/0034"),
    ("IS 2003", 01, 01.1, "History of Linux", 1, "1998/LC/0019"),
    ("IS 2003", 01, 01.2, "Linux Distributions", 1, "1998/LC/0019"),
    ("IS 2003", 01, 01.3, "Installation", 1, "1998/LC/0019"),
    ("IS 2003", 02, 02.1, "VIM Editor", 1, "1998/LC/0019"),
    ("IS 2003", 02, 02.2, "Nano Editor", 1, "1998/LC/0019"),
    ("IS 2003", 02, 02.3, "LaTeX", 1, "1998/LC/0019"),
    ("IS 2003", 03, 03.1, "Libre Office", 1, "1998/LC/0019"),
    ("IS 2003", 03, 03.2, "GIMP", 1, "1998/LC/0019");
...
INSERT INTO KanbanTask (task_id, title, description, due_date, state, course_code, submission_id, stu_reg_no, lec_reg_no) VALUES
    ("Creating a Database", "Create EER digram, mapping and MySQL database for the given scenario", "2022-12-24", 1, "CS 2001", "1C01"),
    ("Assessment 01", "Inclass Quiz", "2023-02-24", 0, "CS 2002", "1C02", ),
    ("Write algorithms to implement given structures", "2023-01-15", 1, "CS 2003", "1C03", "Assignment 01", ),
    ("Assigment 02 - Question Paper", "Answer the questions and upload your answer sheets", "2022-12-18", 2, "CS 2003", "2C03", ),
    ("Assessment 01", "Implement suitable sorting algorithms for given instances", "2023-02-28", 0, "CS 2004", "1C04", ),
    ("Complexity Analysis", "Analyse the complexity of given algorithms", "2022-12-12", 2, "CS 2004", "2C04", ),
    ("Assignment", "Write C codes to implement the given algorithms", "2022-12-28", 1, "IS 2001", "1I01", ),
    ("Assignment - RAD", "Create a single page application usign MERN stack", "2023-01-20", 0, "IS 2002", "1I02", ),
    ("Practical Assessment", "Execute given instructions on your Linux machine and submit a document with screenshots.", "2023-01-10", 0, "IS 2003", "1I03", ),
    ("Assessment 02", "Create the given document usign LaTeX", "2022-12-20", 2, "IS 2003", "2I03", );
